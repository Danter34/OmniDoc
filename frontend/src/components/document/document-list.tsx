      ...
      {[0, 1, 2].map((item) => (
        ...
        >
          <div className="flex items-center gap-3">
            <div className="size-10 rounded-xl bg-surface-tertiary" />
            <div className="flex-1">
              <div className="h-3.5 w-2/3 rounded bg-surface-tertiary" />
              <div className="mt-2 h-3 w-1/3 rounded bg-surface-tertiary" />
            </div>
          </div>
...
export function DocumentList({
  ...
  return (
    <section className="glass-panel overflow-hidden rounded-2xl">
      <div className="flex items-center justify-between border-b border-line-subtle px-4 py-4 sm:px-5">
        <div>
          <h2 className="font-semibold text-content">Tài liệu</h2>
      ...
      <div className="hidden grid-cols-[minmax(0,1fr)_9rem_12rem_12rem] bg-surface-subtle/80 px-5 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-muted lg:grid">
      ...
      {!isLoading && !error && documents.length === 0 ? (
        <div className="px-6 py-14 text-center">
          <span className="mx-auto flex size-12 items-center justify-center rounded-2xl bg-surface-tertiary text-muted">
