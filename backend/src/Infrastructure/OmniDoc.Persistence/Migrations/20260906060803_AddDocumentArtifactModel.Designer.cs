...
namespace OmniDoc.Persistence.Migrations
{
    ...
    [Migration("20260906060803_AddDocumentArtifactModel")]
    partial class AddDocumentArtifactModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmniDoc.Domain.Entities.EmailOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OmniDoc.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OmniDoc.Domain.Entities.WorkspaceInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkspaceId", "InviteeEmail", "Status");
            ...
            modelBuilder.Entity("OmniDoc.Domain.Entities.WorkspaceInvitation", b =>
                {
                    b.HasOne("OmniDoc.Domain.Entities.User", "Inviter")
